...
const lev = {
  ...
  items: [],     // {id_temp, producto_id, cantidad, ubicacion, altura_mayor_3m, tipo_tubo, m_tubo, cable_instr, m_cable_instr, cable_datos, m_cable_datos, cable_elec, m_cable_elec, observacion}
};
...
function guardarEnSesion() {
  try {
    sessionStorage.setItem(STORAGE_KEY, JSON.stringify({ lev, nextLevId }));
