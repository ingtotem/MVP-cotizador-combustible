...
// ============================================================
// AGRUPACIÓN POR REQUERIMIENTO (para los 3 botones del ingeniero)
// El ingeniero elige el grupo, abre el modal y registra cantidades sin ver costos.
// ============================================================

const REQUERIMIENTOS_GRUPOS = {
  LOGISTICA: {
    nombre: 'Logística',
    descripcion: 'Movilización de personal, alquiler de transporte, viáticos, hospedaje',
    icono: '🚚',
    categorias: ['LOGISTICA', 'INDIRECTOS'],
  },
  OBRA_CIVIL: {
    nombre: 'Obra Civil',
    descripcion: 'Resane, excavación, soldadura, trabajos civiles necesarios para la instalación',
    icono: '🧱',
    categorias: ['OBRA_CIVIL'],
  },
  ESPECIALES: {
    nombre: 'Requerimientos Especiales',
    descripcion: 'Permisos, garantías, capacitación, imprevistos por tanque, aforos',
    icono: '⚙',
    categorias: ['PERMISOS', 'GARANTIA', 'CAPACITACION', 'IMPREVISTOS'],
  },
};
