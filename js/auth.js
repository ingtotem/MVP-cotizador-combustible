...
if (!window.__TOTEM_AUTH_INITIALIZED__) {
  ...
  window.PERMISOS = {
    admin:      ['dashboard', 'levantamiento', 'cotizacion', 'oferta', 'proyectos', 'mantenimiento'],
    ingeniero:  ['dashboard', 'levantamiento', 'proyectos'],
    cotizador:  ['dashboard', 'levantamiento', 'cotizacion', 'oferta', 'proyectos'],
    revisor:    ['dashboard', 'levantamiento', 'cotizacion', 'oferta', 'proyectos'],
    lector:     ['dashboard', 'oferta', 'proyectos'],
  };
